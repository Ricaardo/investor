...
Investot 是一个基于大语言模型（LLM）的**全资产智能投资分析中台**。它不仅仅是一个行情查询工具，更是一个具备机构级思维框架的 AI 投资顾问。

## 🌟 核心能力

Investot 旨在辅助专业投资者进行决策，核心能力包括：
...
Investot AI 经过深度调优，支持多种复杂的自然语言指令。以下是典型的使用场景：
...
您可以将 Investot 集成到自己的工作流（如 Notion, Obsidian, Coze）中。
...
## ⚠️ 免责声明
Investot 提供的所有分析基于历史数据和概率模型，**仅供参考，不构成投资建议**。市场有风险，投资需谨慎。
